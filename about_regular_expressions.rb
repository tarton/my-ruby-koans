...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    # Retorna a string buscada que se estiver no inicio
  end

  def test_slash_z_anchors_to_the_end_of_the_string
    assert_equal "end", "start end"[/end\z/]
    assert_equal nil, "start end"[/start\z/]
    # Retorna a string buscada que se estiver no final
  end

  def test_caret_anchors_to_the_start_of_lines
    assert_equal "2", "num 42\n2 lines"[/^\d+/]
    # Retorna o número que está no começo da linha
  end

  def test_dollar_sign_anchors_to_the_end_of_lines
    assert_equal "42", "2 lines\nnum 42"[/\d+$/]
    # Retorna o número que está no final da linha
  end
