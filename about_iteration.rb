...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # 
    # O método inject toma um bloco que será executado para cada elemento
    # no objeto que chamamou o método inject. Então, uma vez que seu Array
    # tenha 3 elementos, o bloco será executado para cada um dos 3 elementos.
