...
class AboutMessagePassing < Neo::Koan
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # Answer: Não causaria o NoMethodError, e a chamada estaria de acordo
    # com o comportamento redefinido. a nota abaixo confirma que é por isso
    # que mudou no Ruby 1.9.
    # 
    # NOTE:
    #
  ...
  def test_explicitly_implementing_respond_to_lets_objects_tell_the_truth
    ...
    assert_equal true, catcher.respond_to?(:foo_bar) # Retorna true para [/foo*/]
